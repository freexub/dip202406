...
<footer id="footer" class="mt-auto py-3 bg-light">
    <div class="container">
        <div class="row text-muted">
            <div class="col-md-12 text-center text-md-start">Дипломный проект: "Разработка веб-приложения для учета личных финансов: анализ расходов, бюджетирование и отчетность"</div>
