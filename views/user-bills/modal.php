                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php $i=0; foreach ($categories as $category) : ?>
                            <input type="radio" class="btn-check" name="UserBillsCategoryTransactions[category_id]" value="<?=$category->id?>" id="option<?=$category->id?>" autocomplete="off" <?php ($i>0)?:'checked'?>>
